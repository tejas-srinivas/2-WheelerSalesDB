...
<html lang="en">
  <head>
    ...
    <link href="dio.css" rel="stylesheet" type="text/css"> 
    <title>Dio details</title>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="dio1.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="dio2.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="dio3.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="dio4.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="dio5.jpg" class="d-block w-100" alt="...">
          </div>
