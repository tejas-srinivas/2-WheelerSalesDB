...
<html lang="en">
  <head>
    ...
    <link href="aprila.css" rel="stylesheet" type="text/css"> 
    <title>Aprilia details</title>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="aprilia1.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="aprilia2.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="aprilia3.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="aprilia4.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="aprilia5.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="aprilia6.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="aprilia7.png" class="d-block w-100" alt="...">
          </div>
